          ...
          <div className="row bg-transparent-1 rounded-4 p-3 corner-mother">
            ...
            <div className="col-md-3 ps-4">
              ...
              <ul className="lh-lg pe-4 small">
                ...
                <li className="text-center pt-5 pb-md-0 pb-3">
                  <a href="https://chic-kangaroo-f04315.netlify.app" target="_blank"
            ...
            <div className="col-md-9 row">
              <div className="col-md-12 p-2">
                <img src="portfolio-1/1.png" alt="" className="rounded-3" />
              </div>

              <div className="col-md-4 p-2">
                <img src="portfolio-1/2.png" alt="" className="rounded-3" />
              </div>
              <div className="col-md-4 p-2">
                <img src="portfolio-1/3.png" alt="" className="rounded-3" />
              </div>
              <div className="col-md-4 p-2">
                <img src="portfolio-1/4.png" alt="" className="rounded-3" />
              </div>
            </div>
          </div>
        </div>
